...
public class EasyModeActivity extends AppCompatActivity {
    ...
    Button btnContinuar;
    int easymodeMC1, easymodeMC2;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_easy_mode);
        getSupportActionBar().setTitle("EASY MODE");
        TextView mc1 = findViewById(R.id.easymode_mc1);
        TextView mc2 = findViewById(R.id.easymode_mc2);
        btnContinuar = (Button) findViewById(R.id.btnEasyModeContinuar);
        mc1patron1 = findViewById(R.id.em1p1);
        mc1patron2 = findViewById(R.id.em1p2);
        mc1patron3 = findViewById(R.id.em1p3);
        mc1patron4 = findViewById(R.id.em1p4);
        mc1patron5 = findViewById(R.id.em1p5);
        mc1patron6 = findViewById(R.id.em1p6);
        mc1extra1 = findViewById(R.id.em1e1);
        mc1extra2 = findViewById(R.id.em1e2);
        mc1extra3 = findViewById(R.id.em1e3);
        mc2patron1 = findViewById(R.id.em2p1);
        mc2patron2 = findViewById(R.id.em2p2);
        mc2patron3 = findViewById(R.id.em2p3);
        mc2patron4 = findViewById(R.id.em2p4);
        mc2patron5 = findViewById(R.id.em2p5);
        mc2patron6 = findViewById(R.id.em2p6);
        mc2extra1 = findViewById(R.id.em2e1);
        mc2extra2 = findViewById(R.id.em2e2);
        mc2extra3 = findViewById(R.id.em2e3);
        ...
        btnContinuar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                puntuar();
                Intent pasarPantalla = new Intent(EasyModeActivity.this, HardModeActivity.class);
    ...
    private void puntajeMC1() {
        ...
        easymodeMC1 = patron1 + patron2 + patron3 + patron4 + patron5 + patron6 + extra1 + extra2 + extra3;
    }
    ...
    private void puntajeMC2() {
        ...
        easymodeMC2 = patron1 + patron2 + patron3 + patron4 + patron5 + patron6 + extra1 + extra2 + extra3;
    }
    ...
    private void puntuar(){
        ...
        editor.putInt("easymodeMC1", easymodeMC1);
        editor.putInt("easymodeMC2", easymodeMC2);
        editor.commit();
    }
