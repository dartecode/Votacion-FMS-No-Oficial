...
public class Tematica1Activity extends AppCompatActivity {
    ...
    int tematica1MC1, tematica1MC2;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tematica1);
        getSupportActionBar().setTitle("TEMATICA 1");
        TextView mc1 = findViewById(R.id.tematica_mc1);
        TextView mc2 = findViewById(R.id.tematica_mc2);
        Button btnContinuar = findViewById(R.id.btnTematica1Continuar);

        mc1patron1 = findViewById(R.id.t1mc1p1);
        mc1patron2 = findViewById(R.id.t1mc1p2);
        mc1patron3 = findViewById(R.id.t1mc1p3);
        mc1patron4 = findViewById(R.id.t1mc1p4);
        mc1extra1 = findViewById(R.id.t1mc1e1);
        mc1extra2 = findViewById(R.id.t1mc1e2);
        mc1extra3 = findViewById(R.id.t1mc1e3);
        mc2patron1 = findViewById(R.id.t1mc2p1);
        mc2patron2 = findViewById(R.id.t1mc2p2);
        mc2patron3 = findViewById(R.id.t1mc2p3);
        mc2patron4 = findViewById(R.id.t1mc2p4);
        mc2extra1 = findViewById(R.id.t1mc2e1);
        mc2extra2 = findViewById(R.id.t1mc2e2);
        mc2extra3 = findViewById(R.id.t1mc2e3);
        ...
        btnContinuar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                puntuar();
                Intent pasarPantalla = new Intent(Tematica1Activity.this, Tematica2Activity.class);
    ...
    private void puntajeMC1() {
        ...
        tematica1MC1 = patron1 + patron2 + patron3 + patron4 + extra1 + extra2 + extra3;
    }
    ...
    private void puntajeMC2() {
        ...
        tematica1MC2 = patron1 + patron2 + patron3 + patron4 + extra1 + extra2 + extra3;
    }
    ...
    private void puntuar(){
        ...
        editor.putInt("tematica1MC1", tematica1MC1);
        editor.putInt("tematica1MC2", tematica1MC2);
        editor.commit();
    }
